...
namespace WpfApp
{
    class Water
    {
        ...
        public Water(Random rnd, int width, int height)
        {
            this.rnd = rnd;
            this.width = width;
            this.height = height;

            columns = new WaterColumn[width / scale];
        ...
        public void Update()
        {
            ...
            particles = particles.Where(x => x.Position.X >= 0 && x.Position.X <= 800 && x.Position.Y - 5 <= height).ToList();
        }
        ...
        public void Splash(double x, float speed)
        {
        ...
        public void Draw(DrawingContext dc)
        {
            ...
            dc.DrawGeometry(Brushes.DeepSkyBlue, new Pen(Brushes.LightBlue, 1), streamGeometry);

            foreach (var particle in particles)
            {
                var p = new Point(particle.Position.X, particle.Position.Y);
                dc.DrawEllipse(Brushes.DeepSkyBlue, null, p, particle.r, particle.r);
            }
